...
monitored using Smart Handpump sensors for 2014 and 2015 in Kwale, Kenya.[^1][^2]
...
The `location` data set has 6 variables and 299 observations. 
They record 299 hand pumps location information.
...
The two datasets follows the same structure and we here use `weeklyvol2014` as an illustration.
```{r echo=FALSE}
readr::read_csv("data-raw/dictionary.csv") |>
...
![hand pump location map](man/figures/README-location.png)
